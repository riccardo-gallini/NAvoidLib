...
//! @brief  RG 2016 - Types that describe the orientation of connector that a ConnEnd 
//!         represents. Can be Source, Target or None.
//!
public enum ConnEndOrientation {
	//! @brief  The ConnEnd does not represent any particular side in connector orientation.
	ConnEndNotOriented = 0,
	//! @brief  The ConnEnd represents the source for an oriented connector.
	ConnEndSource = 1,
	//! @brief  The ConnEnd represents the target for an oriented connector.
	ConnEndTarget = 2
};
...
class AVOID_EXPORT ConnEnd 
{
    public:
		...
		//! @brief  RG 2016 - Orientation of connector that a ConnEnd represents. 
		//!                   Can be Source, Target or None.
		ConnEndOrientation Orientation();
		void SetOrientation(ConnEndOrientation orientation);
    ...
    private:
        ...
        void assignPinVisibilityTo(VertInf *dummyConnectionVert, VertInf *targetVert, ConnEndOrientation wanted_orientation); //RG2016
		...
		// RG 2016 The orientation for this ConnEnd;
		ConnEndOrientation m_orientation;
};
